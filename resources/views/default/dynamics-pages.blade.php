                        ...
                        <div class="hero_section">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-sm-5">
                                    {!! Html::image('assets/img/page/' . $page['images'], $page['name'], ['class' => 'zoomIn wow animated']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="inner_section">
                            <div class="row">
                                <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">
                                    {!! Html::image('assets/img/page/' . $page['images'], $page['name'], ['class' => 'img-circle delay-03s animated wow zoomIn']) !!}
                                </div>
